...
class ModCharts
{
	 ...
	 */
	 static public var autoStrum:Bool = true;
	...
	static public function flipNoteDown(sprite)//put the strum 
		{
			FlxTween.angle(sprite, 0, 180, 0.5, {
				type: FlxTween.ONESHOT,
				ease: FlxEase.quadInOut,
				startDelay: 0,
				loopDelay: 0
		...
		static public function flipNoteUp(sprite)//put the strum 
			{
				FlxTween.angle(sprite, 0, 0, 0.5, {
					type: FlxTween.ONESHOT,
					ease: FlxEase.quadInOut,
					startDelay: 0,
					loopDelay: 0
	...
	static public function strumBounce1(notesGroup:FlxTypedGroup<FlxSprite>, x, y, time, distancebetweennotes = 50, startingnum = 0) {
		var num = 0;
		var end = 110;
		var mid = 410;
		//this is a copy bc im too lazy to remake it
		notesGroup.forEach(function(note)
		{
			num = num + mid;
			ModCharts.cancelMovement(note);
	...
	static public function strumBounce2(notesGroup:FlxTypedGroup<FlxSprite>, x, y, time, distancebetweennotes = 50, startingnum = 0) {
		var num = 0;
		var end = 110;
		var mid = 180;
		//this is a copy bc im too lazy to remake it
