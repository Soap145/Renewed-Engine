...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function create()
	{
		...
		UI_box2.resize(300, 200);
		UI_box2.x = FlxG.width / 2;
		UI_box2.y = 440;
		add(UI_box2);
	...
	function addModchartsUI():Void
	{
		...
		var tab_group_md = new FlxUI(null, UI_box2);
		tab_group_md.name = "Modcharts";
		tab_group_md.add(mdEnabled);


		UI_box2.addGroup(tab_group_md);
	...
	function addPresetsUi():Void
		{
			var vcEnabled = new FlxUICheckBox(90, 15, null, null, "Auto Bf Vocals", 100);
			vcEnabled.checked = _song.preVocals;
			// _song.needsVoices = check_voices.checked;
			vcEnabled.callback = function()
			{
				_song.preVocals = vcEnabled.checked;
				trace('CHECKED!');
			};
	
			var tab_group_vc = new FlxUI(null, UI_box2);
			tab_group_vc.name = "Presets";
			tab_group_vc.add(vcEnabled);
	
	
			UI_box2.addGroup(tab_group_vc);
			UI_box2.scrollFactor.set();
			UI_box2.scrollFactor.set();
	...
	function addSongUI():Void
	{
		...
		//FlxG.switchState(new ChartingError());
