	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			...
			case Triple:
				...
				inline bindKeys(Control.RESET, [R]);
		    case Fourth:
				inline bindKeys(Control.UP, [O]);
				inline bindKeys(Control.DOWN, [W]);
				inline bindKeys(Control.LEFT, [Q]);
				inline bindKeys(Control.RIGHT, [P]);
				inline bindKeys(Control.ACCEPT, [G, Z]);
				inline bindKeys(Control.BACK, [H, X]);
				inline bindKeys(Control.PAUSE, [ONE]);
				inline bindKeys(Control.RESET, [R]);
			case Fith:
				inline bindKeys(Control.UP, [N]);
				inline bindKeys(Control.DOWN, [X]);
				inline bindKeys(Control.LEFT, [Z]);
				inline bindKeys(Control.RIGHT, [M]);
				inline bindKeys(Control.ACCEPT, [G, Z]);
				inline bindKeys(Control.BACK, [H, X]);
				inline bindKeys(Control.PAUSE, [ONE]);
				inline bindKeys(Control.RESET, [R]);
